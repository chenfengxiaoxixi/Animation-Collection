...
#import "CurvilinearMotionController.h"

@interface CurvilinearMotionController ()
{
    UIImageView *bgImage;
...
@implementation CurvilinearMotionController
...
- (void)initNode{
    ...
    _earthNode.geometry.firstMaterial.diffuse.contents = @"SceneKitSrc.scnassets/sphere_football.png";
    _earthNode.geometry.firstMaterial.emission.contents = @"SceneKitSrc.scnassets/sphere_football.png";
    _earthNode.geometry.firstMaterial.specular.contents = @"SceneKitSrc.scnassets/sphere_football.png";
    _moonNode.geometry.firstMaterial.diffuse.contents = @"SceneKitSrc.scnassets/sphere_football.png";
    _sunNode.geometry.firstMaterial.multiply.contents = @"SceneKitSrc.scnassets/sphere_football.png";
    _sunNode.geometry.firstMaterial.diffuse.contents = @"SceneKitSrc.scnassets/sphere_football.png";
